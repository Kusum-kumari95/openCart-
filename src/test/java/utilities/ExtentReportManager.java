...
public void onFinish(ITestContext testContext) {
	...
	try {
		...
		email.setAuthenticator(new DefaultAuthenticator("pathinikusum95@gmail.com", "PKUM!1995ari"));
		email.setSSLOnConnect(true);
		email.setFrom("pathinikusum95@gmail.com"); //sender
		email.setSubject("Test Results");
		email.setMsg("Please find attached Report...");
		email.addTo("pathinikusum95@gmail.com"); //Receiver
